...
class User(UserMixin, db.Model):
    ...
    exam_results = db.relationship('ExamResult', back_populates='user', lazy=True, cascade="all, delete-orphan")
    accesses = db.relationship('ExamAccess', back_populates='user', lazy=True, cascade="all, delete-orphan")
    access_requests = db.relationship('ExamAccessRequest', back_populates='user', lazy=True, cascade="all, delete-orphan")
